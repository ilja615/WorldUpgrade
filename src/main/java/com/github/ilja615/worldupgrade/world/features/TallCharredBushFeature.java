...
public class TallCharredBushFeature extends Feature<NoFeatureConfig>
{
    ...
    private static final BlockState BOTTOM_TALL_CHARRED_BUSH = ModBlocks.TALL_CHARRED_BUSH.get().getDefaultState().with(DoubleReedPlantBlock.HALF, DoubleBlockHalf.LOWER);
    private static final BlockState TOP_TALL_CHARRED_BUSH = ModBlocks.TALL_CHARRED_BUSH.get().getDefaultState().with(DoubleReedPlantBlock.HALF, DoubleBlockHalf.UPPER);
    ...
    public boolean generate(ISeedReader worldIn, ChunkGenerator chunkGenerator, Random rand, BlockPos startPosition, NoFeatureConfig config)
    {
        ...
        setBlockState(worldIn, startPosition, BOTTOM_TALL_CHARRED_BUSH);
        setBlockState(worldIn, startPosition.up(1), TOP_TALL_CHARRED_BUSH);
