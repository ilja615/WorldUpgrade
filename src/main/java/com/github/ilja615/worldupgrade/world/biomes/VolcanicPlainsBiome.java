...
public class VolcanicPlainsBiome extends Biome
{
    public VolcanicPlainsBiome()
    {
        super(new Builder()
                .surfaceBuilder(new ConfiguredSurfaceBuilder<>(ModBiomeFeatures.VOLCANIC_SURFACE_BUILDER, SurfaceBuilder.GRAVEL_CONFIG))
