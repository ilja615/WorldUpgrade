...
public class CharredForestSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig>
{
    // Uh idk if this noise generetar is ok.
    ...
    public CharredForestSurfaceBuilder(Codec<SurfaceBuilderConfig> p_i232136_1_) {
        super(p_i232136_1_);
    }
