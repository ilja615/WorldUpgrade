...
public class DeadTreeFeature extends Feature<NoFeatureConfig>
{
    ...
    private static final BlockState LEAF = ModBlocks.DEAD_LEAVES.get().defaultBlockState().setValue(LeavesBlock.DISTANCE, 1);

    public DeadTreeFeature(Codec<NoFeatureConfig> p_i231953_1_) {
        super(p_i231953_1_);
    }
