...
public class BlisteringPlainsBiome extends Biome
{
    public BlisteringPlainsBiome()
    {
        super(new Builder()
                .surfaceBuilder(new ConfiguredSurfaceBuilder<>(ModSurfaceBuilders.VOLCANIC_SURFACE_BUILDER.get(), SurfaceBuilder.GRAVEL_CONFIG))
        ...
        this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, ModBiomeFeatures.SMOKE_VENT_FIRE_JET.get().withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG).withPlacement(Placement.COUNT_EXTRA_HEIGHTMAP.configure(new AtSurfaceWithExtraConfig(0, 0.3F, 1))));
        ...
        this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, ModBiomeFeatures.DEAD_TREE.get().withConfiguration(DefaultBiomeFeatures.OAK_TREE_CONFIG).withPlacement(Placement.COUNT_EXTRA_HEIGHTMAP.configure(new AtSurfaceWithExtraConfig(0, 0.4F, 1))));
