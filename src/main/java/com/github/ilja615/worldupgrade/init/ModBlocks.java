...
public class ModBlocks
{
    ...
    // Terrain Blocks:
    public static final RegistryObject<Block> GRAVEL_DARK = BLOCKS.register("gravel_dark", () -> new GravelBlock(-8356741, ModProperties.GRAVEL_PROPERTY));
    public static final RegistryObject<Block> GRAVEL_LIGHT = BLOCKS.register("gravel_light", () -> new GravelBlock(-8356741, ModProperties.GRAVEL_PROPERTY));
