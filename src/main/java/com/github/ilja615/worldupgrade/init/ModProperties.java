...
public class ModProperties
{
    ...
    public static final Block.Properties BIG_PLANT_OR_GUNNERA_PROPERTY = Block.Properties.create(Material.LEAVES).sound(SoundType.PLANT).hardnessAndResistance(0.2F, 1.0F);
    public static final Block.Properties BIG_WATER_LILY_PROPERTY = Block.Properties.create(Material.LEAVES).sound(SoundType.LILY_PADS).hardnessAndResistance(0.2F, 1.0F);
