...
public class ModBlocks
{
    ...
    public static OvergrownJungleRockBlock JUNGLE_ROCK_OVERGROWN = new OvergrownJungleRockBlock(ModProperties.OVERGROWN_JUNGLE_ROCK_PROPERTY);
    ...
    public static BlockLeavesCarpet DRAGON_LEAVES_CARPET = new BlockLeavesCarpet("dragon_leaves_carpet", ModProperties.LEAVES_PROPERTY);
