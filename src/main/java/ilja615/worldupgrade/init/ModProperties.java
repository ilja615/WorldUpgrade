...
public class ModProperties
{
    ...
    public static final Block.Properties LEAVES_PROPERTY = Block.Properties.create(Material.LEAVES).sound(SoundType.PLANT).hardnessAndResistance(0.2F, 1.0F).tickRandomly();
    ...
    public static final Block.Properties ALOE_VERA_OR_AGAVE_PROPERTY = Block.Properties.create(Material.EARTH).sound(SoundType.GROUND).hardnessAndResistance(0.4F, 2.0F);
