...
public class BiomeCloudForrest extends Biome
{
    public BiomeCloudForrest()
    {
        super((new Builder()).surfaceBuilder(new ConfiguredSurfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG)).precipitation(RainType.RAIN).category(Category.EXTREME_HILLS).depth(1.1F).scale(0.3F).temperature(0.75F).downfall(0.9F).waterColor(4159204).waterFogColor(329011).parent((String)null));
