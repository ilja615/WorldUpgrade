...
public class CharEmbersFeature extends Feature<NoFeatureConfig>                                                                              {
   private static final Block CHAREMBERSBLOCK = ModBlocks.CHAR_EMBERS.get()                                                                  ;

   public CharEmbersFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> p_i49894_1_)                                                     {
      super(p_i49894_1_);
                                                                                                                                             }
   ...
   public boolean place(IWorld worldIn, ChunkGenerator<? extends GenerationSettings> generator, Random rand, BlockPos pos, NoFeatureConfig config)
      ...
      BlockState blockstate1 = CHAREMBERSBLOCK.getDefaultState()                                                                             ;
