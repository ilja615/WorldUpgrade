...
public class CharredForrestSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig>
{
    ...
    public CharredForrestSurfaceBuilder(Function<Dynamic<?>, ? extends SurfaceBuilderConfig> deserializer)
    {
        super(deserializer);
    }
