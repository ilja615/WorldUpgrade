...
public class ClientProxy implements IProxy
    {
        ...
        RenderTypeLookup.setRenderLayer(ModBlocks.DRY_TALL_REED, RenderType.getCutout());
        RenderTypeLookup.setRenderLayer(ModBlocks.DRY_TOP_REED, RenderType.getCutout());
